    ...
    public partial class InitDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_activity_attendees", x => new { x.user_id, x.activity_id });
                    table.ForeignKey(
                        name: "fk_activity_attendees_activities_activity_id",
                        column: x => x.activity_id,
                        principalTable: "activities",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_activity_attendees_users_user_id",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_comments_activities_activity_id",
                        column: x => x.activity_id,
                        principalTable: "activities",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_user_followings", x => new { x.observer_id, x.target_id });
                    table.ForeignKey(
                        name: "fk_user_followings_asp_net_users_observer_id",
                        column: x => x.observer_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_user_followings_asp_net_users_target_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_activity_attendees_activity_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_followings_target_id",
